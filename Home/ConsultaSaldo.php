	...
	<body>
		<div class="container">
			...
			<form role="form" action="ConsultaSaldo.php" method="post" class="login-form">
                    ...
                    <input type="text" readonly= "readonly" value = "<?php echo $dados['cont_saldo'];?> " name="form-username" placeholder="Palavra Chave..." class="form-username form-control" id="form-Palavra">
